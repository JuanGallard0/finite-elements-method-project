    ...
    public:
        ...
        */
        static DS<float>* calculate_local_M(Element* e){
            ...
            //Se definen los elementos de la matriz de acuerdo a la fórmula posición por posición
            SDDS<float>::insert(M,0,0,(1/60)); SDDS<float>::insert(M,0,1,(1/60)); SDDS<float>::insert(M,0,2,(1/60));
            SDDS<float>::insert(M,1,0,(1/120)); SDDS<float>::insert(M,1,1,(1/60)); SDDS<float>::insert(M,1,2,(1/60));
            SDDS<float>::insert(M,2,0,(1/120)); SDDS<float>::insert(M,2,1,(1/60)); SDDS<float>::insert(M,2,2,(1/120));

            //Se multiplica el contenido de la matriz M por el factor rho*Cp*J/24
            Math::product_in_place(M, J);
        ...
        */
        static DS<float>* calculate_local_K(Element* e){
            ...
            Math::product_in_place(K, 1/(120*D*D));
        ...
        static DS<float>* calculate_local_H(Element* e){
            ...
            DS<float>* temp;
            SDDS<float>::create(&temp,3,2,MATRIX);
            //Se definen los elementos de la matriz de acuerdo a la fórmula posición por posición
            SDDS<float>::insert(temp,0,0,(1/24)); SDDS<float>::insert(temp,0,1,(1/24)); 
            SDDS<float>::insert(temp,1,0,(1/24)); SDDS<float>::insert(temp,1,1,(1/24)); 
            SDDS<float>::insert(temp,2,0,(1/12)); SDDS<float>::insert(temp,2,1,(1/12)); 

            //Se efectúa B^T * A^T * A * B y el resultado se almacena en <K>
            DS<float>* temp2 = Math::product( temp, A );
            H = Math::product( temp2, B );
            SDDS<float>::destroy(temp);SDDS<float>::destroy(temp2);

            //Se multiplica el contenido de la matriz K por el factor k*Area/D^2
            Math::product_in_place(H, J/D);
        ...
        */
        static DS<float>* calculate_local_b(Element* e){
            ...
            //Se definen los elementos de la matriz de acuerdo a la fórmula posición por posición
            SDDS<float>::insert(b,0,0,(1/20));
            SDDS<float>::insert(b,1,0,(11/120));
            SDDS<float>::insert(b,2,0,(3/40));
        ...
        */
        static void apply_Dirichlet(int nnodes, int free_nodes, DS<float>** b, DS<float>* K, DS<float>* H, float Td, DS<int>* dirichlet_indices){
