...
int main(int argc, char** argv){
    ...
    DS<float> *T, *T_full, *T_N, *M, *K, *H,*b;
    DS<int> *dirichlet_indices, *neumann_indices;

    DS<DS<float>*> *Result,*M_locals,*K_locals,*H_locals,*b_locals;
    ...
    while( t <= tf ){
        ...
        SDDS<DS<float>*>::create(&H_locals, nelems, ARRAY);
        ...
        SDDS<float>::create(&H, nnodes, nnodes, MATRIX); Math::zeroes(H);
        ...
        FEM::apply_Dirichlet(nnodes, free_nodes, &b, K, H, Td, dirichlet_indices);
        FEM::apply_Dirichlet(nnodes, free_nodes, &K, dirichlet_indices);
        FEM::apply_Dirichlet(nnodes, free_nodes, &H, dirichlet_indices);
